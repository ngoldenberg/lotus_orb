(function($) {
  $.fn.tweet = function(o){
    ...
    function extract_template_data(item){
      ...
      o.tweet_text = jQuery([o.tweet_raw_text]).linkUrl().linkUser().linkHash()[0];
      o.tweet_text_fancy = jQuery([o.tweet_text]).makeHeart().capAwesome().capEpic()[0];
    ...
    return this.each(function(i, widget){
      ...
      jQuery(widget).bind("tweet:load", function(){

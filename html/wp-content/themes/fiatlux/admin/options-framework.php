...
function optionsframework_add_page() {
	...
	$of_page = add_submenu_page('themes.php', 'Theme Options', __('Theme Options', 'meydjer'), 'edit_theme_options', 'options-framework','optionsframework_page');
...
function optionsframework_page() {
	...
	<h2><?php _e( 'Theme Options', 'meydjer' ); ?></h2>
    ...
    <div id="of_container">
	  ...
	  <?php settings_fields('optionsframework'); ?>
        ...
        <div id="header">
          <div class="logo">
            <h2><?php _e('Theme Options', 'meydjer'); ?></h2>
					...
					<input type="submit" class="button-primary" name="update" value="<?php _e('Save Options', 'meydjer'); ?>" style="margin: 20px 20px 0 0;" />
          <div class="clear"></div>
        </div>
        <div id="main">
        ...
        <div class="of_admin_bar">
			<input type="submit" class="button-primary" name="update" value="<?php _e('Save Options', 'meydjer'); ?>" />
            <input type="submit" class="reset-button button-secondary" name="reset" value="<?php _e('Restore Defaults', 'meydjer'); ?>" onclick="return confirm( '<?php print esc_js( _e( 'Click OK to reset. Any theme settings will be lost!','meydjer' ) ); ?>' );" />
		</div>
<div class="clear"></div>
	</form>
</div> <!-- / #container -->  
...
function optionsframework_validate($input) {
	...
	if (!empty($_POST['reset'])) {
		...
		if (delete_option($option_name) ) {
			add_settings_error('options-framework', 'restore_defaults', __('Default options restored.','meydjer'), 'updated fade');
		}
	}
	...
	if ( isset($clean) ) {
		add_settings_error('options-framework', 'save_options', __('Options saved.','meydjer'), 'updated fade');
...
function optionsframework_adminbar() {
	...
	$wp_admin_bar->add_menu( array(
		'parent' => 'appearance',
		'id' => 'of_theme_options',
		'title' => __( 'Theme Options','meydjer' ),

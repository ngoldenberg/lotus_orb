<?php
if((of_get_option('ml_standard_bg') == 'fullscreen_bg') || (of_get_option('ml_gallery_custom_bg'))) {
	if(of_get_option('ml_gallery_custom_bg')){
		$fullscreen_bg = of_get_option('ml_gallery_custom_bg');
	} else {
...
if((of_get_option('ml_standard_bg') == 'pattern_bg') && (!of_get_option('ml_gallery_custom_bg'))) {

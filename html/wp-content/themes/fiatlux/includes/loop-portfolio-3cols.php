...
?>
	...
	<article id="post-<?php the_ID(); ?>" <?php post_class($portfolio_item . ' ml_one_third ml_with_padding ml_boxed ml_visible'); ?>>
		...
		if(get_post_meta($post->ID, 'ml_fc_featured_content', true) == 'lightbox_youtube') {
			...
			<a href="<?php echo $featured_content; ?>" class="featured-image ml_icon_video" data-rel="prettyPhoto[portfolio]" title="<?php echo $featured_description; ?>">
				<img src="<?php echo get_template_directory_uri() . '/includes/timthumb.php?src=' . $featured_content . '&h=138&w=246&zc=1&q=100'; ?>" alt="" width="246" height="138" /></a>
			</a>
		...
		elseif(get_post_meta($post->ID, 'ml_fc_featured_content', true) == 'lightbox_vimeo') {
			...
			$content_poster = get_template_directory_uri() . '/includes/timthumb.php?src=' . $content_poster . '&w=246&h=138&zc=1&q=100';
			?>

			<a href="<?php echo $featured_content; ?>" class="featured-image ml_icon_video" data-rel="prettyPhoto[portfolio]" title="<?php echo $featured_description; ?>">
				<img src="<?php echo $content_poster; ?>" alt="" width="246" height="138" /></a>
			</a>
	  ...
	  jQuery(document).ready(function(){
		...
		$embedded_video_height = 'style="height:138px;"';
		?>
	  ...
	  jQuery(document).ready(function(){
		...
		$embedded_html_poster = get_template_directory_uri() . '/includes/timthumb.php?src=' . $embedded_html_poster . '&w=246&h=138&zc=1&q=100'
		?>
			<a href="<?php the_permalink(); ?>" class="featured-image ml_icon_html">
				<img src="<?php echo $embedded_html_poster; ?>" alt="HTML" width="246" height="138" />	
			</a>
		<?php 	}
		...
		<div class="ml_nivo-slider">
			<?php	for ($slide_num = 1; $slide_num <= 10; $slide_num++) { 
				$slide = get_post_meta($post->ID, 'ml_fc_image_slider_'.$slide_num, true);
					if($slide) {
						$slide = get_template_directory_uri() . '/includes/timthumb.php?src=' . $slide . '&h=246&w=246&zc=1&q=100';
					?>
		...
		//if don't have a featured content, get tue full image URL
			...
			$featured_class = 'ml_icon_picture';
				...
				<a href="<?php echo $featured_image; ?>" class="featured-image ml_icon_picture" data-rel="prettyPhoto[portfolio]" title="<?php echo $featured_description; ?>">
					<img src="<?php echo get_template_directory_uri() . '/includes/timthumb.php?src=' . $featured_image . '&h=246&w=246&zc=1&q=100'; ?>" alt="" width="246" height="246" /></a>
				</a>
				<?php
				}
		} ?>

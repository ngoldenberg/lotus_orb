...
define ('MAX_FILE_SIZE', 10000000);			// file size limit to prevent possible DOS attacks (roughly 1.5 megabytes) (***NOTE: For this theme, I have changed the value to 10MB ***)

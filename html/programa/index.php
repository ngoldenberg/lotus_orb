			...
			<div id="templatemo_content">
				...
				<div id="templatemo_right_content">
					<div id="templatemo_content_area">
						...
						<p>Bienvenido al sistema de administracion de datos de Travertino Andino S.A.</br></br> Para poder usar cualquier funcion de este sistema, usted debe estar logueado con una respectiva cuenta. 
						</br></br>Si tiene consultas acerca del funcionamiento o uso del sistema, puede dirigirse a la seccion de <a href="ayuda.php">ayuda</a>.</p>
	...
	<div class="templatemo_section_bottom_line"></div>
		...
		<div id="templatemo_right_content">
			<div id="templatemo_content_area">
				...
				<p>Usted se encuentra logueado en el sistema. 
				</br></br>Si tiene consultas acerca del funcionamiento o uso del sistema, puede dirigirse a la seccion de <a href="ayuda.php">ayuda</a>.</p>
